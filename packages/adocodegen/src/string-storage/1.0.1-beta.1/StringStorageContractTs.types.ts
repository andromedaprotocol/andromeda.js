...
export type StringStorageRestriction = "private" | "public" | "restricted";
...
export interface GetDataOwnerResponse {
  owner: AndrAddr;
}
...
export type StringStorageContractTsExecuteMsg = ExecuteMsg;