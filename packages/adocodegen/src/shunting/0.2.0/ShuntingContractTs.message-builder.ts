...
export abstract class ShuntingContractTsExecuteMsgBuilder {
  static updateExpressions = ({
    expressions
  }: CamelCasedProperties<Extract<ExecuteMsg, {
    update_expressions: unknown;
  }>["update_expressions"]>): ExecuteMsg => {
    return {
      update_expressions: ({
        expressions
      } as const)
...
export abstract class ShuntingContractTsQueryMsgBuilder {
  static evaluate = ({
    params
