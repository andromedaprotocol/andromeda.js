...
export type CounterRestriction = "private" | "public";
...
export interface GetDecreaseAmountResponse {
  decrease_amount: number;
}
export interface GetIncreaseAmountResponse {
  increase_amount: number;
}
export interface GetInitialAmountResponse {
...
export type CounterContractTsExecuteMsg = ExecuteMsg;