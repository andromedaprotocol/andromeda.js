...
export abstract class BooleanContractTsExecuteMsgBuilder {
  static setValue = ({
    value
  ...
  static deleteValue = (): ExecuteMsg => {
    return {
      delete_value: ({} as const)
    };
  };
...
export abstract class BooleanContractTsQueryMsgBuilder {
  static getValue = (): QueryMsg => {
    return {
      get_value: ({} as const)
    };
  };
  static getDataOwner = (): QueryMsg => {
    return {
      get_data_owner: ({} as const)
    };
  };
