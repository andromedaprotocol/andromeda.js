...
export interface PresaleTierOrder {
  amount: Uint128;
  level: Uint64;
  orderer: Addr;
}
export interface SimpleTierOrder {
  amount: Uint128;
  level: Uint64;
}
...
export interface TierOrdersResponse {
  orders: SimpleTierOrder[];
}
export interface TiersResponse {
  tiers: TierResponseItem[];
}
export interface TierResponseItem {
  sold_amount: Uint128;
  tier: Tier;
}
