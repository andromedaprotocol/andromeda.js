...
export abstract class AddressListContractTsExecuteMsgBuilder {
  static addActorPermission = ({
    actor,
    permission
  }: CamelCasedProperties<Extract<ExecuteMsg, {
    add_actor_permission: unknown;
  }>["add_actor_permission"]>): ExecuteMsg => {
    return {
  ...
  static removeActorPermission = ({
    actor
  }: CamelCasedProperties<Extract<ExecuteMsg, {
    remove_actor_permission: unknown;
  }>["remove_actor_permission"]>): ExecuteMsg => {
    return {
